...
def generate_launch_description():
    ...
    default_waypoints_yaml = (
        '/home/cat/hitcrt_quad_ws/src/commands/lidar_nav_demo_cpp/config/waypoints.yaml'
    )
    prepath_yaml = '/home/cat/hitcrt_quad_ws/src/commands/lidar_nav_demo_cpp/config/prepath.yaml'
    ...
    anchor_recorder_script = (
        '/home/cat/hitcrt_quad_ws/src/pythontool/record_anchor_points.py'
    )
    ...
    obstacle_nav_node = Node(
        ...
        namespace='quad',
        output='screen',
        parameters=[base_config, parku_config],
    )
