...
/home/cat/hitcrt_quad_ws/src/commands/lidar_nav_demo_cpp/config/prepath.yaml
```
...
field_generated_points_file: "/home/cat/hitcrt_quad_ws/src/commands/lidar_nav_demo_cpp/config/waypoints_generated.yaml"
```
...
```bash
rg -n "/home/cat|hitcrt_quad_ws|point_lio|paddleocrDeploy|ros2_ws|gpiochip|\\.rknn" src scripts
```
