...
bool is_positive_limit_param(const std::string& name) {
    return name == "max_vx" ||
           ...
           name == "lidar_tf_min_rate_hz" ||
           name == "lidar_tf_rate_window_s" ||
           name == "lidar_tf_timeout_s";
}
      ...
      is_waiting_(false)
{
    ...
    this->declare_parameter(
        ...
        "/home/cat/hitcrt_quad2026_ws/src/commands/lidar_nav_demo_cpp/config/manip_points_generated.yaml");
    this->declare_parameter(
        "field_anchor_points_file",
        "/home/cat/hitcrt_quad2026_ws/src/commands/lidar_nav_demo_cpp/config/trajectories/example_point.txt");
    ...
    this->declare_parameter("cross_band_pass_through_dist_arrival_tolerance", 0.50);
    ...
    this->declare_parameter("lidar_tf_rate_guard_enable", true);
    this->declare_parameter("lidar_tf_min_rate_hz", 8.0);
    this->declare_parameter("lidar_tf_rate_window_s", 1.0);
    this->declare_parameter("lidar_tf_timeout_s", 0.30);
    this->declare_parameter("lidar_pose_guard_enable", true);
    this->declare_parameter("lidar_pose_min_x", -10.0);
    this->declare_parameter("lidar_pose_max_x", 10.0);
    this->declare_parameter("lidar_pose_min_y", -10.0);
    this->declare_parameter("lidar_pose_max_y", 15.0);
    ...
    this->declare_parameter("logistics_entry_trajectory_path",
        "/home/cat/hitcrt_quad2026_ws/src/commands/lidar_nav_demo_cpp/config/trajectories/record_pass.txt");
    ...
    cross_band_pass_through_dist_arrival_tolerance_ =
        this->get_parameter("cross_band_pass_through_dist_arrival_tolerance").as_double();
    ...
    lidar_tf_rate_guard_enable_ =
        this->get_parameter("lidar_tf_rate_guard_enable").as_bool();
    lidar_tf_min_rate_hz_ =
        this->get_parameter("lidar_tf_min_rate_hz").as_double();
    lidar_tf_rate_window_s_ =
        this->get_parameter("lidar_tf_rate_window_s").as_double();
    lidar_tf_timeout_s_ =
        this->get_parameter("lidar_tf_timeout_s").as_double();
    lidar_pose_guard_enable_ =
        this->get_parameter("lidar_pose_guard_enable").as_bool();
    lidar_pose_min_x_ = this->get_parameter("lidar_pose_min_x").as_double();
    lidar_pose_max_x_ = this->get_parameter("lidar_pose_max_x").as_double();
    lidar_pose_min_y_ = this->get_parameter("lidar_pose_min_y").as_double();
    lidar_pose_max_y_ = this->get_parameter("lidar_pose_max_y").as_double();
    if (lidar_pose_min_x_ >= lidar_pose_max_x_ || lidar_pose_min_y_ >= lidar_pose_max_y_) {
        RCLCPP_ERROR(this->get_logger(),
                     "Invalid lidar pose guard bounds; using default x[-10,10] y[-10,15].");
        lidar_pose_min_x_ = -10.0;
        lidar_pose_max_x_ = 10.0;
        lidar_pose_min_y_ = -10.0;
        lidar_pose_max_y_ = 15.0;
    }
    ...
    enable_sub_ = this->create_subscription<std_msgs::msg::Bool>(
        enable_topic_, 10, [this](const std_msgs::msg::Bool::SharedPtr msg) {
            ...
            if (!new_enable) {
                ...
                lidar_tf_rate_guard_active_ = false;
                lidar_tf_guard_stop_sent_ = false;
                lidar_pose_guard_active_ = false;
    ...
    const std::vector<rclcpp::Parameter>& parameters)
{
    ...
    double new_cross_band_pass_through_dist_arrival_tolerance =
        cross_band_pass_through_dist_arrival_tolerance_;
    ...
    bool new_lidar_tf_rate_guard_enable = lidar_tf_rate_guard_enable_;
    double new_lidar_tf_min_rate_hz = lidar_tf_min_rate_hz_;
    double new_lidar_tf_rate_window_s = lidar_tf_rate_window_s_;
    double new_lidar_tf_timeout_s = lidar_tf_timeout_s_;
    bool new_lidar_pose_guard_enable = lidar_pose_guard_enable_;
    double new_lidar_pose_min_x = lidar_pose_min_x_;
    double new_lidar_pose_max_x = lidar_pose_max_x_;
    double new_lidar_pose_min_y = lidar_pose_min_y_;
    double new_lidar_pose_max_y = lidar_pose_max_y_;
    ...
    for (const auto& parameter : parameters) {
        ...
        if (name == "approach_lateral_yaw_comp_enable" ||
            ...
            name == "lidar_tf_rate_guard_enable" ||
            name == "lidar_pose_guard_enable") {
            bool value = false;
            ...
            } else if (name == "logistics_cmd_slew_vy_enable") {
                new_logistics_cmd_slew_vy_enable = value;
            } else if (name == "lidar_tf_rate_guard_enable") {
                new_lidar_tf_rate_guard_enable = value;
            } else {
                new_lidar_pose_guard_enable = value;
            }
            continue;
        }
        ...
        } else if (name == "cross_band_pass_through_dist_arrival_tolerance") {
            new_cross_band_pass_through_dist_arrival_tolerance = value;
        ...
        } else if (name == "lidar_tf_min_rate_hz") {
            new_lidar_tf_min_rate_hz = value;
        } else if (name == "lidar_tf_rate_window_s") {
            new_lidar_tf_rate_window_s = value;
        } else if (name == "lidar_tf_timeout_s") {
            new_lidar_tf_timeout_s = value;
        } else if (name == "lidar_pose_min_x") {
            new_lidar_pose_min_x = value;
        } else if (name == "lidar_pose_max_x") {
            new_lidar_pose_max_x = value;
        } else if (name == "lidar_pose_min_y") {
            new_lidar_pose_min_y = value;
        } else if (name == "lidar_pose_max_y") {
            new_lidar_pose_max_y = value;
    ...
    if (new_lidar_pose_min_x >= new_lidar_pose_max_x) {
        result.reason = "lidar_pose_min_x must be < lidar_pose_max_x";
        return result;
    }
    if (new_lidar_pose_min_y >= new_lidar_pose_max_y) {
        result.reason = "lidar_pose_min_y must be < lidar_pose_max_y";
        return result;
    }
    ...
    cross_band_pass_through_dist_arrival_tolerance_ =
        new_cross_band_pass_through_dist_arrival_tolerance;
    ...
    const bool lidar_tf_rate_guard_config_changed =
        lidar_tf_rate_guard_enable_ != new_lidar_tf_rate_guard_enable ||
        lidar_tf_min_rate_hz_ != new_lidar_tf_min_rate_hz ||
        lidar_tf_rate_window_s_ != new_lidar_tf_rate_window_s ||
        lidar_tf_timeout_s_ != new_lidar_tf_timeout_s;
    lidar_tf_rate_guard_enable_ = new_lidar_tf_rate_guard_enable;
    lidar_tf_min_rate_hz_ = new_lidar_tf_min_rate_hz;
    lidar_tf_rate_window_s_ = new_lidar_tf_rate_window_s;
    lidar_tf_timeout_s_ = new_lidar_tf_timeout_s;
    if (lidar_tf_rate_guard_config_changed) {
        lidar_tf_sample_times_.clear();
        lidar_tf_rate_guard_active_ = false;
        lidar_tf_guard_stop_sent_ = false;
    }
    const bool lidar_pose_guard_config_changed =
        lidar_pose_guard_enable_ != new_lidar_pose_guard_enable ||
        lidar_pose_min_x_ != new_lidar_pose_min_x ||
        lidar_pose_max_x_ != new_lidar_pose_max_x ||
        lidar_pose_min_y_ != new_lidar_pose_min_y ||
        lidar_pose_max_y_ != new_lidar_pose_max_y;
    lidar_pose_guard_enable_ = new_lidar_pose_guard_enable;
    lidar_pose_min_x_ = new_lidar_pose_min_x;
    lidar_pose_max_x_ = new_lidar_pose_max_x;
    lidar_pose_min_y_ = new_lidar_pose_min_y;
    lidar_pose_max_y_ = new_lidar_pose_max_y;
    if (lidar_pose_guard_config_changed) {
        lidar_pose_guard_active_ = false;
    }
...
bool LidarNavControl::is_dynamic_nav_param(const std::string& name) const {
    static const std::unordered_set<std::string> kDynamicParams = {
        ...
        "cross_band_pass_through_dist_arrival_tolerance",
        ...
        "lidar_offset_x",
        "lidar_offset_y",
        "lidar_tf_rate_guard_enable",
        "lidar_tf_min_rate_hz",
        "lidar_tf_rate_window_s",
        "lidar_tf_timeout_s",
        "lidar_pose_guard_enable",
        "lidar_pose_min_x",
        "lidar_pose_max_x",
        "lidar_pose_min_y",
        "lidar_pose_max_y",
