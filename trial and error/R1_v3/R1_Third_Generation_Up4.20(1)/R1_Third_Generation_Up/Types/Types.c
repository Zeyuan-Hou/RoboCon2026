...
float PoleArm_Joint1_3508_Fetch_Position=365.f; //存取杆机械臂第一个关节的3508电机取杆位置
...
float PoleArm_Joint2_2006_Fetch_Position =-15.f; //存取杆机械臂第二个关节的2006电机取杆位置
...
//	 0,//初始化不使用PID时将所有结构体成员赋值为零
    .outer={.fpEMin=0.f,.fpSumEMax=20000,.fpUMax=16800,.fpUpMax=12000.f,.fpUdMax=4000.f,.fpEMax=10000,.fpKp=0,.fpKi=0,.fpKd=0},
    .inner={.fpEMin=0.f,.fpSumEMax=100,.fpUMax=16800,.fpUpMax=12000.f,.fpUdMax=4000.f,.fpEMax=100000,.fpKp=150,.fpKi=0,.fpKd=0}
};

ST_PID PoleArm_Adjustment_PID=
{
	.fpKd=0.f,.fpKi=0.f,.fpKp=0.8f,.fpEMax=100.f,.fpUdMax=40.f,.fpUpMax=30.f,.fpUMax=50.f,
    .fpSumEMax=100.f,
};
