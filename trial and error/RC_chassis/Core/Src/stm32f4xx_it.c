...
void USART6_IRQHandler(void)
{
  ...
  if (__HAL_UART_GET_FLAG(&huart6, UART_FLAG_IDLE))
  {
    ...
    huart6.Instance->DR; // clear ore flg
    huart6.Instance->SR;
    g_uart_rx_cnt = 512 - __HAL_DMA_GET_COUNTER(huart6.hdmarx); // get length of received data
    g_uart_rx_buf[g_uart_rx_cnt] = 0;                           //

    __HAL_DMA_CLEAR_FLAG(huart6.hdmarx, DMA_FLAG_TCIF1_5 | DMA_FLAG_HTIF1_5 | DMA_FLAG_TEIF1_5);
    __HAL_DMA_SET_COUNTER(huart6.hdmarx, 512); // reset length of rx dma
