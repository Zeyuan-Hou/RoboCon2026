...
private:
    ...
    TaskOffset get_active_task_offset(int task_id) const;
    ...
    void publish_visual_velocity_cmd(const VisualBodyErrors& errors, int task_id);
    ...
    bool check_pole_replay_finished(double elapsed, double t_end);
    ...
    bool sample_pole_reference(double elapsed, double& x, double& y, double& yaw) const;
    ...
    std::map<int, TaskOffset> task_config_map_;
