...
extern uint8_t g_uart_rx_buf[512];	/*rx DMA buffer of uart2*///���ڽ��ջ�����
extern uint16_t g_uart_rx_cnt; /*reciede data length of uart2*///��ʾ���ڽ��ջ������н��յ����ݳ���

extern uint8_t g_decode_data[512];	/*buffer for decoding*///���ݽ��뻺����
extern uint16_t g_decode_data_pos;	/*bytes left in decode buffer*///���뻺�����еĵ�ǰλ��
/*------------------------------------------------Functions declare--------------------------------------------*/
...
extern GYRO_DATA gyro_data,gyro_data_filtered;//ŷ����
