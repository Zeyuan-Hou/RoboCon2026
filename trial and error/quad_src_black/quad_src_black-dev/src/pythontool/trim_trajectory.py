...
用法:
  python3 trim_trajectory.py -i ../commands/lidar_nav_demo_cpp/config/trajectories/recorded_path.txt
  python3 trim_trajectory.py -i recorded_path.txt -o recorded_path_trimmed.txt
  python3 trim_trajectory.py -i recorded_path.txt --in-place
  python3 trim_trajectory.py -i recorded_path.txt --pos-eps 0.08 --step-eps 0.03
"""
...
def main() -> int:
    default_input = (
        ...
        / "commands/lidar_nav_demo_cpp/config/trajectories/record_pass.txt"
    )
