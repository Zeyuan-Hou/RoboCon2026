...
#include "algorithm.h"
GYRO_DATA gyro_data,gyro_data_filtered;//ŷ����


uint8_t g_uart_rx_buf[512];	//���ڽ��ջ�����
uint16_t g_uart_rx_cnt = 0; //��ʾ���ڽ��ջ������д����������ݳ���

uint8_t g_decode_data[512];	//���ݽ��뻺����
...
void data_filter(void){
    const float smooth = 40;                    // ƽ���ȼ���һ�׵�ͨ�˲�����ֹƵ��
    static ST_LPF FJ_ax = {0, 0, 0, smooth, 0.001f}; // ��Ҫpre_out������Ҫ��Ϊ��̬����
