...
void VOFA_pack_data(){ // 由CH_COUNT宏定义至多20位float，当前波特率921600理论上可发送40位float
   ...
   vofa[2] = chassis_run.leftdown.fpDes;
   vofa[3] = chassis_run.leftdown.fpU;
   vofa[4] = chassis_run.rightdown.fpDes;
   vofa[5] = chassis_run.rightdown.fpU;
   vofa[6] = chassis_run.leftup.fpDes;
   vofa[7] = chassis_run.leftup.fpU;
   vofa[8] = chassis_run.rightup.fpFB;
   vofa[9] = chassis_run.leftdown.fpFB;
   vofa[10] = chassis_run.rightdown.fpFB;
   vofa[11] = chassis_run.leftup.fpFB;
