...
POINT point_init[14] =
    {
        {.x = 2000 - length_differX_1 - 100 - length_differX_2 - 15, .y = 1800 - length_differY_2},
        {.x = 2000 - length_differX_1 - 100 - length_differX_2 - 15, .y = 3000 - length_differY_2},
        {.x = 2000 - length_differX_1 - 100 - length_differX_2 - 15, .y = 4200 - length_differY_2},
        {.x = 2600 - length_differX_2, .y = 1200 - length_differX_1 - 100 - length_differY_2 - 30},
        /*删了-20*/ {.x = 2600 - length_differX_2, .y = 4800 + length_differX_1 + 100 - length_differY_2 + 10},
        {.x = 3800 - length_differX_2, .y = 1200 - length_differX_1 - 100 - length_differY_2 - 30},
        {.x = 3800 - length_differX_2, .y = 4800 + length_differX_1 + 100 - length_differY_2 + 10},
        {.x = 5000 - length_differX_2, .y = 1200 - length_differX_1 - 100 - length_differY_2 - 30},
        {.x = 5000 - length_differX_2, .y = 4800 + length_differX_1 + 100 - length_differY_2 + 10},
        {.x = 6200 - length_differX_2, .y = 1200 - length_differX_1 - 100 - length_differY_2 - 30},
        {.x = 6200 - length_differX_2, .y = 4800 + length_differX_1 + 100 - length_differY_2 + 10},
        {.x = 6800 + length_differX_1 + 100 - length_differX_2 - 40 + 10, .y = 1800 - length_differY_2},
        {.x = 6800 + length_differX_1 + 100 - length_differX_2 - 40 + 10, .y = 3000 - length_differY_2},
        {.x = 6800 + length_differX_1 + 100 - length_differX_2 - 40 + 10, .y = 4200 - length_differY_2},
};
POINT point_turn_1to2 = {
    .x = 1500 - length_differX_2,
    .y = 1200 - length_differY_2,
};                                                                                    // 1区转2区的转弯点
