...
ST_Nav nav = {
	...
	.auto_path = {
		...
		.pos_pid = {
			.x = {.fpKp = 1.6f, .fpKi = 0.05f, .fpKd = 0.2f, .fpUMax = 2000.f, .fpUpMax = 1500.f, .fpUdMax = 500.f, .fpSumEMax = 3000.f, .fpEMax = 1000.f, .fpEMin = 0.0f},
			.y = {.fpKp = 1.6f, .fpKi = 0.05f, .fpKd = 0.2f, .fpUMax = 2000.f, .fpUpMax = 1500.f, .fpUdMax = 500.f, .fpSumEMax = 3000.f, .fpEMax = 1000.f, .fpEMin = 0.0f},
			.w = {.fpKp = 2.f, .fpKi = 0.05f, .fpKd = 0.2f, .fpUMax = 150.f, .fpUpMax = 120.f, .fpUdMax = 50.f, .fpSumEMax = 600.f, .fpEMax = 300.f, .fpEMin = 0.0f},
...
uint8_t flag_lock = 0;
PATH_POINT Path_Point = {.point_inx = 0, .flag_point_to_point = 1, .flag_path_set = 0, .point_tim = 0};
Cube_Line cube_x, cube_y, cube_w;
Quintic_Line quintic_x, quintic_y, quintic_w;
Bezier_3rd bezier;
PATH_FEEDFORWARD path_ff = {.k1_x = 1.f, .k2_x = 0.f, .k1_y = 1.f, .k2_y = 0.f, .k1_w = 1.f, .k2_w = 0.f};

// 主状态机
ACE_Manipulator ace = {.state = 255, .across = 0, .flag_ = 0, .path_inx = 255, .flag = 1, .flag__ = 0};
